...
Procurei não usar biblioteca externa, exceto o axios, que é habitualmente usado para lidar com as requisiçõe HTTP.

A aplicação consiste em uma tela de listagem de transações financeiras. Nela pode ser aplicado um filtro por título da transação ou status.
